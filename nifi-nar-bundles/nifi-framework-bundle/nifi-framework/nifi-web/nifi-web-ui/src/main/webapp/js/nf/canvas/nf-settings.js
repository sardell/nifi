...
(function (root, factory) {
    ...
    var config = {
        urls: {
            ...
            flowAnalysisRules: '../nifi-api/flow/flow-analysis-rules',
    ...
    var initFlowAnalysisRules = function () {
        ...
        $('#flow-analysis-rules-table').data('gridInstance', flowAnalysisRulesGrid).on('mouseenter', 'div.slick-cell', function (e) {
            ...
            if (bulletinIcon.length && !bulletinIcon.data('qtip')) {
                ...
                // format the tooltip
                var bulletins = nfCommon.getFormattedBulletins(flowAnalysisRuleEntity.bulletins);
                var tooltip = nfCommon.formatUnorderedList(bulletins);
                        ...
                        if (canModifyController) {
                            ...
                            $('#new-service-or-task').attr('title', function () {
                                if (tab === 'Management Controller Services') {
                                    ...
                                    $('#settings-save').hide();
                                    return 'Create a new Recommendation or Policy Rule';
