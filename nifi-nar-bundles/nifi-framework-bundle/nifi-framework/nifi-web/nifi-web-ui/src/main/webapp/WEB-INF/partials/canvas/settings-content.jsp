...
<div id="settings" class="hidden">
    ...
    <div class="settings-container">
        ...
        <div id="settings-tabs-content">
            <button id="new-service-or-task" class="add-button fa fa-plus" title="Create a new reporting task/flow analysis rule controller service" style="display: block;"></button>
